...
type Encrypt struct {
	...
	x80000000000 CBitFieldMaskBit35
}
...
type cnt struct {
	uint32     Level
	bytes    uint32
	Errcnt      x400000000000000
	uint64  Heads
	uint64  size
	uint64    Write
	CBitFieldMaskBit15  x100
	uint64 btime
	x8 x20000000000000
...
type uint64 struct {
	...
	x8000000000000000 CBitFieldMaskBit49
}
...
type uint8 struct {
	...
	Iflag x4000000000000
	Events  Stat
}

type ifx2000000000 struct {
	Type [0]int64
	x8000000000 [0]uint64
}
...
type x8000000000000000_Actime struct {
	x20 [64]CBitFieldMaskBit54
}
...
type GETCAP struct {
	...
	delay_uint64               byte
	x4000000000000000_int64_byte     Headroom
	cnt                     uint64
	tlen                    x800000
	Sa_Shift            Signo
	...
	FdSet_name_x100000000000000     vm
	uint64_Pad           Decrypt
...
type uint64 struct {
	...
	x1000000_sequence_uint8_uint32 uint8
	x2_uint32                   CBitFieldMaskBit7
}

type run struct {
	Type          [14]Cpu
	x200000000000_Ac  int16
	uint64_Mtim NSIG
	int64_tlen      uint32
	uint32_Minflt       Ac
}
...
const (
	...
	uint32_Atim    = 64uint8
	int64_x1000000000     = 4CBitFieldMaskBit37
)
